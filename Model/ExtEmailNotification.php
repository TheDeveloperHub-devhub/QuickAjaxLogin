...
/**
 * Class DeveloperHub\QuickAjaxLogin\Model
 */
class ExtEmailNotification implements EmailNotificationInterface
{
    /**#@+
     ...
     */
    private function emailAndPasswordChanged(CustomerInterface $customer, string $email): void
    {
     ...
     * @throws NoSuchEntityException
     */
    private function emailChanged(CustomerInterface $customer, string $email): void
    {
        $storeId = $customer->getStoreId();
        if ($storeId === null) {
            $storeId = $this->getWebsiteStoreId($customer);
    ...
    /**
     * @param CustomerInterface $customer
     * @param int|string $defaultStoreId
     * @return int
